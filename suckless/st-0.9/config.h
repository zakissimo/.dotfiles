 ...
 */
static char *font = "FiraCode Nerd Font:style=Retina:pixelsize=15:antialias=true:autohint=true";
static char *font2[] = { "DejaVu Sans Code:pixelsize=11:antialias=true:autohint=true" };
