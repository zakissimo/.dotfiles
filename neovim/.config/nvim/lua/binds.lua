...
map("n", "<Leader>7", ":lua require('harpoon.ui').nav_file(1)<CR>", opts)
map("n", "<Leader>8", ":lua require('harpoon.ui').nav_file(2)<CR>", opts)
map("n", "<Leader>9", ":lua require('harpoon.ui').nav_file(3)<CR>", opts)
map("n", "<Leader>0", ":lua require('harpoon.ui').nav_file(4)<CR>", opts)
map("n", "<Leader>-", ":lua require('harpoon.ui').nav_file(5)<CR>", opts)
