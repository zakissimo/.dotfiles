...
map("n", "<C-y>", ":lua require('harpoon.mark').add_file()<CR>", opts)
map("n", "<C-u>", ":lua require('harpoon.ui').toggle_quick_menu()<CR>", opts)
map("n", "<C-7>", ":lua require('harpoon.ui').nav_file(1)<CR>", opts)
map("n", "<C-8>", ":lua require('harpoon.ui').nav_file(2)<CR>", opts)
map("n", "<C-9>", ":lua require('harpoon.ui').nav_file(3)<CR>", opts)
map("n", "<C-0>", ":lua require('harpoon.ui').nav_file(4)<CR>", opts)
map("n", "<C-->", ":lua require('harpoon.ui').nav_file(5)<CR>", opts)
