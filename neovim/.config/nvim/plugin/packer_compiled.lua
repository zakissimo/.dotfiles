...
_G.packer_plugins = {
  ["42header"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/42header",
  ...
  ["c_formatter_42.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/c_formatter_42.vim",
  ...
  ["norminette42.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/norminette42.nvim",
